...
function About() { // full page as component imported in router
  ...
  return (
    ...
    <div>
      ...
      <main >
        <Banner imgSrc={imgBanner} bannerText="" darken={false} /> {/* Banner with background picture and caption, darken boolean to add css class */}
        <div className="main-container-about"> {/* styled in 'style.scss' */}
          {listRubriques.map((rub, index) => (
            <Collapse key={index} title={rub.title} infos={rub.infos} page="about" />
          ))}
        </div>
